...
import { setFingerprintDetails, setFirstFingerprintCaptured } from "../../../lib/users/userReducer";
...
const Page = () => {
  ...
  useEffect(() => {
    secondFingerprintCaptured && compareFingerPrints(fingerprintTemplate, data.bmpBase64);
