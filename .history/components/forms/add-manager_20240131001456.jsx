          ...
          <div className="flex flex-wrap -mx-3 mb-2">
            ...
            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <div className="relative">
                <select
                  className="block appearance-none w-3/4  border border-gray-200 text-gray-700 dark:text-gray-300 py-3 px-4 pr-8 rounded leading-tight focus:outline-none  focus:border-gray-500"
                  id="grid-state"
                >
                  {accessPoints.map((category) => (
                    <option className="" value={category._id}>
                      {category.name}
                    </option>
                  ))}
                </select>
