...
function RadioSelector({ title, description, isSelected, onRadioChange }) {
  return (
    <div className="relative mb-4">
      ...
      />
      <span className="absolute left-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white peer-checked:border-gray-900">
        Ksh.500
      </span>
