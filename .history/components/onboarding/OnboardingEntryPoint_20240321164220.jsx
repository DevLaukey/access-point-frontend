        ...
        <div className="my-auto mx-auto flex flex-col justify-center pt-8 md:justify-start lg:w-[34rem]">
          <div className="flex w-full flex-col  px-2 sm:px-14">
            ...
            <div className="flex justify-center items-center gap-2">
              <Link
                href="/"
                className="text-blue-500 dark:text-gray-400 text-md  underline w-full"
              >
                Add Details Later
              </Link>
              <Button
                ...
                className="w-full justify-center bg-gray-300 hover:bg-gray-400 text-blue-800  dark:text-slate-50 font-bold py-2 px-4 rounded inline-flex items-center"
              >
                <span>Continue</span>
