...
export default function AnimatedPrimaryButton({
  ...
  return (
    ...
    >
      <Button
        disabled={disabled}
        className={`group relative w-full flex items-center justify-center px-10 py-4 text-xl md:w-auto ${className}`}>
...
export default function AnimatedPrimaryButton({
  ...
  return (
    ...
    >
      <span
        className="absolute inset-0 flex h-full -translate-x-full items-center justify-center text-black dark:text-white duration-300 group-hover:translate-x-0"
      >
        <svg
          className="h-6 w-6"
          fill="none"
      ...
      <span
        className="absolute flex h-full w-full items-center justify-center text-black dark:text-white transition-all duration-300 group-hover:translate-x-full"
      >
        {children}
      </span>
      <span className="invisible relative">{children}</span>
