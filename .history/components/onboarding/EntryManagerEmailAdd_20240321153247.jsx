    ...
    <div className="flex flex-wrap">
      ...
      <form>
        <div className="flex flex-col  px-2 justify-center items-center gap-2 my-2">
          ...
          <button className="w-full  justify-center -gray-300 hover:bg-gray-400 text-gray-800  dark:text-slate-50 font-bold py-2 px-4 rounded inline-flex items-center">
            <span>Continue</span>
