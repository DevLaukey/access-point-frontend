...
function SubscriptionCards() {
  return (
    <>
      <h2 className="font-serif text-2xl font-semibold text-gray-700 h-full">
      ...
      <div className="mt-8 flex w-full flex-col pb-8">
        ...
        <div className="relative mb-4">
          <input
            ...
            name="radio"
          />
          <span className=" right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white peer-checked:border-gray-900"></span>
          <label
            className="flex cursor-pointer flex-col rounded-2xl border border-gray-300 bg-slate-100/80 p-4 pr-8 sm:pr-16"
            htmlFor="radio_2"
          >
